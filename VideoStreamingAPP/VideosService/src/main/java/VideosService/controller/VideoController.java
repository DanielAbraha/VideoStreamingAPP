...
import VideosService.integration.VideoNotificationSender;
...
public class VideoController {
    ...
    @Autowired
    private VideoNotificationSender videoNotificationSender;
    @Autowired
    ...
    public VideoDto addVideo(@RequestBody VideoDto videoDto){
        ...
        videoNotificationSender.sendUploadVideoMessage(videoDto);
    ...
    public String deleteVideo(@PathVariable String id) {
        ...
        videoNotificationSender.sendDeleteVideoMessage(videoDto);
