...
public class AuthController {
    ...
    public ResponseEntity<?> signIn(@RequestBody AuthRequest authRequest){
        ...
        if(authentication.isAuthenticated()){
            String token = userService.generateToken(authRequest.getEmail(),authRequest.getRole());//, roleRepository.findRoleByRoleName(authRequest.getRole().getRoleName())
    ...
    public ResponseEntity<String> lockAccount(@PathVariable String email, @RequestParam boolean accountNonLocked){
        userService.lockUser(email, accountNonLocked);
        if(accountNonLocked)
        return new ResponseEntity<>(HttpStatus.OK);
        else System.out.println("Account Locked");
